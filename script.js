...
// Automatically detect API URL (works for both local and production)
const APIURL = (window.location.origin === 'file://' || window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')
